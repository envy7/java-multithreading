        ...
        final Thread sleepyThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // No exception is thrown with below. Merely calling interrupt method isn't responsible for throwing
                    // exception. Implementation sleep / wait, periodically checks the interrupt status and takes action
